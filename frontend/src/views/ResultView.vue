...
import SurfaceView from '@/components/evaluation/SurfaceView.vue'
import DeepView from '@/components/evaluation/DeepView.vue'
import CorrectedView from '@/components/evaluation/CorrectedView.vue'
