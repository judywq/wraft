...
ADMINS = [("Judy Wang", "judywang.jp@gmail.com")]
...
# TODO: set to whatever value is adequate in your circumstances
CELERY_TASK_SOFT_TIME_LIMIT = 12 * 60 * 60  # 12 hours
...
# Vue
# -------------------------------------------------------------------------------
FRONTEND_USE_DEV_SERVER = DEBUG
FRONTEND_DEV_SERVER_URL = "http://localhost:5173"
FRONTEND_DEV_SERVER_PATH = "src/"
FRONTEND_STATIC_DIR = "vue"
FRONTEND_USE_TYPESCRIPT = False
# Your stuff...
...
# LLM Caller
# ------------------------------------------------------------------------------
LLM_GATEWAY_LLM_PURPOSE_CHOICES = [
    ("surface_correction", "Surface Correction"),
    ("surface_explain", "Surface Explain"),
    ("macro_correction", "Macro Correction"),
    ("micro_correction", "Micro Correction"),
    ("score", "Score"),
]

LLM_GATEWAY_INIT_LLM_CONFIGS = {
    "surface_correction": {
        "model": "openai/gpt-4o-mini-2024-07-18",
        "template": "backend/myapp/templates/prompts/surface_correction_prompt.txt",
        "example_output": "backend/myapp/templates/prompts/surface_correction_prompt_example.txt",
        "temperature": 0.7,
    },
    "surface_explain": {
        "model": "openai/gpt-4o-mini-2024-07-18",
        "template": "backend/myapp/templates/prompts/surface_explain_prompt.txt",
        "example_output": "backend/myapp/templates/prompts/surface_explain_prompt_example.txt",
        "temperature": 0.7,
    },
    "macro_correction": {
    ...
    "score": {
        "model": "openai/ft:gpt-4o-2024-08-06:waseda-university:eassy-eval:AVLSHV8x",
        "template": "backend/myapp/templates/prompts/score_prompt.txt",
        "example_output": "backend/myapp/templates/prompts/score_prompt_example.txt",
        "temperature": 0,
    },
}
