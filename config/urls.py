...
if settings.DEBUG:
    ...
    urlpatterns += [
        ...
        # Test email endpoint: /send-email/<method>/<email>/
        # method: 1 = send_mail, 2 = EmailMessage
        # Example: /send-email/1/test@example.com/
        path("send-email/<int:method>/<str:to>/", send_test_email),
    ]
