...
The settings are defined in `config/settings/base.py`. For more details, check `backend/llm_gateway/management/commands/init_llm_data.py`.
...
1. Visit http://localhost:8000/admin/llm_gateway/llmsettings/
2. Add a new LLMSetting record
3. Set "Fake LLM request" to True
4. Configure example outputs in http://localhost:8000/admin/llm_gateway/modelconfig/
